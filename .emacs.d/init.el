...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (solaire-mode doom-themes treemacs-evil treemacs intero doom-modeline modeline smart-mode-line evil nord-theme ido-vertical-mode haskell-mode use-package))))
(custom-set-faces
