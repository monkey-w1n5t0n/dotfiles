...
(use-package! org-roam
  ...
  :custom
  (org-roam-directory "~/phd/org-roam")
...
(setq
 ...
 evil-move-cursor-back nil ;; TODO
...
(setq operator-cursor-color "#65d4f3")
...
;; (map!
;;  :prefix "o"
;;  :n "s" 'sp-slurp-hybrid-sexp
;;  :n "S" 'sp-forward-barf-sexp
;;  :n "h" 'sp-backward-slurp-sexp
;;  :n "H" 'sp-backward-barf-sexp
;;  )
#+end_src
