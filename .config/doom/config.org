...
(setq org-archive-location (concat org-archive-directory "/%s_archive.org::"))
...
(use-package! org-roam
  ...
  (org-roam-db-location "~/notes/org-roam/org-roam.db")
...
*** TODO delete?
#+begin_src elisp :tangle no
;; from https://karl-voit.at/2021/04/10/GLT21-emacs-org-features/
